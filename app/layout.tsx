...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Delírio Tropical — Restaurante Saudável desde 1983',
    template: '%s | Delírio Tropical',
  },
  description: 'Culinária natural, fresca e saborosa desde 1983. Lojas no Rio de Janeiro e Niterói. Encomendas online, delivery e eventos corporativos.',
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Delírio Tropical — Restaurante Saudável desde 1983',
      },
    ],
  },
  twitter: {
