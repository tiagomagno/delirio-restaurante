export const metadata = {
  ...
  description: 'Faça parte da equipe Delírio Tropical. Confira as vagas disponíveis para atendente, auxiliar de cozinha, saladeiro, cozinheiro e mais. Candidate-se agora.',
}
  ...
  return (
    <main>
      <div className="page-hero">
        <h1 className="page-hero__title">Trabalhe com a Gente</h1>
        <p className="page-hero__subtitle">Faça parte da nossa equipe</p>
      </div>
      ...
      <div className="trabalhe-layout">
        ...
        <div className="trabalhe-layout__form">
          <h2 className="trabalhe-form__title">Trabalhe com a Gente</h2>
