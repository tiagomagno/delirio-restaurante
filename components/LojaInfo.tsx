...
/* ─── Identidade + botões de ação (como chegar / delivery / cardápio) ─── */
export function LojaIdentityActions({ loja }: { loja: StoreData }) {
  return (
...
/* ─── Horário + contatos ─── */
export function LojaDetails({ loja }: { loja: StoreData }) {
